...
(function () {
  ...
  var easings = function () {
    ...
    var names = ['Ease', 'Quad', 'Cubic', 'Quart', 'Quint', 'Sine', 'Expo', 'Circ', 'Back', 'Elastic'];
    ...
    var equations = {
      In: [[0.420, 0.000, 1.000, 1.000], /* InEase */
      ...
      elastic /* InElastic */
      ], Out: [[0.000, 0.000, 0.580, 1.000], /* OutEase */
      ...
      }], InOut: [[0.420, 0.000, 0.580, 1.000], /* InOutEase */
    ...
    var functions = {
      ...
      cubic4001: bezier(0.400, 0.000, 0.000, 1.000),
      cubic4021: bezier(0.400, 0.000, 0.200, 1.000)
    };
